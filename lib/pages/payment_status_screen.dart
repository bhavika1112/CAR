...
class _PaymentStatusScreenState extends State<PaymentStatusScreen> {
  ...
  List<Widget> _buildSummaryCards(BuildContext context) {
    final cardWidth = ResponsiveHelper.isMobile(context) ? 180.0 : double.infinity;
  ...
  Widget _buildViewTab(String label, bool isSelected) {
    return Container(
      padding: EdgeInsets.symmetric(
        vertical: ResponsiveHelper.getResponsiveValue(context, mobile: 10, tablet: 12, desktop: 14)
      ),
      decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Price Details
          _buildPriceRow('Car Price:', carPrice, context),
          const SizedBox(height: 8),
          _buildPriceRow('Platform Fee:', platformFee, context),
          const SizedBox(height: 8),
          Container(
            ...
            child: _buildPriceRow('Net Amount:', netAmount, context),
          ),
          const SizedBox(height: 16),
