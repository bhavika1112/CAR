          ...
          decoration: BoxDecoration(
            ...
            _buildSection(
              ...
              content: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildBulletPoint('Beautifully maintained Aston Martin DB11 featuring a petrol-powered 4.0 L twin-turbo V8 engine and 8-speed automatic transmission.'),
                  _buildBulletPoint('Single owner, driven just 16,000 km, with 2+2 seating (4-seater grand tourer) in excellent condition.'),
                  _buildBulletPoint('Recently serviced with brand-new tires and battery, and full authorized service history available.'),
                  _buildBulletPoint('No accident history; interior and exterior meticulously cared for.'),
                  _buildBulletPoint('Combines luxury and performance, offering a 0-100 km/h time of under 4 seconds and a top speed over 300 km/h.'),
                  _buildBulletPoint('A perfect grand touring coupe for long drives and refined city cruising.'),
                ],
              ),
            ),
