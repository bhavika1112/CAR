...
class CarListingBase extends StatelessWidget {
  ...
  Widget _buildDescription() {
    return _section(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: descriptionPoints.map((point) => _bulletPoint(point)).toList(),
      ),
    );
  }

  Widget _section({required String title, required Widget child, bool useOswald = false}) {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            title,
            style: useOswald
                ? GoogleFonts.oswald(fontSize: 20, fontWeight: FontWeight.w600)
  ...
  List<Widget> _conditionItems() {
    ...
    return items
        .map((item) => _conditionItem(item.$1, item.$2))
        .toList();
  }

  Widget _conditionItem(String text, String type) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            text,
            style: GoogleFonts.oswald(fontSize: 13, fontWeight: FontWeight.w500),
          ),
        ],
      ),
    );
  ...
  Widget _buildDocuments() {
    return _section(
      ...
      child: Column(
        children: [
          _docItem('RC (Registration Certificate)', 'Available'),
          const SizedBox(height: 10),
          _docItem('Insurance', 'Valid till Dec 2024'),
          const SizedBox(height: 10),
          _docItem('PUC Certificate', 'Valid till Jan 2025'),
        ],
      ),
    );
  }

  Widget _docItem(String title, String status) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black, blurRadius: 6, offset: const Offset(0, 1),
          ),
        ],
      ),
      child: Row(
  ...
  Widget _buildServiceHistory() {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white, border: Border.all(color: const Color(0xFFE0E0E0)),
          borderRadius: BorderRadius.circular(12),
          boxShadow: [
            BoxShadow(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Service History',
              style: GoogleFonts.oswald(fontSize: 18, fontWeight: FontWeight.w600),
            ),
            const SizedBox(height: 12),
            Text(
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.black, blurRadius: 6, offset: const Offset(0, 2),
            ),
          ],
        ),
        child: Column(
